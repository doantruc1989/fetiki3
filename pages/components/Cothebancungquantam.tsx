    ...
    <Card className="bg-white w-full lg:w-11/12 mx-auto">
      <div className="flex justify-between">
        <div className="flex contents-start items-center">
          <h5 className="text-lg ml-1 md:text-xl font-bold text-gray-900 dark:text-white">
      ...
      >
        {products?.map((product: any) => {
          return (
            <div
              className="relative rounded-md border mx-1 border-gray-200 shadow-sm hover:shadow-xl bg-white mb-1"
              key={product?.id}
            >
